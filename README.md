assistr
Handbuch für neue Coaches
davidinho2303.github.io/wiesel2-dashboard/Drill.html

Überblick
assistr ist die digitale Coaching-Plattform der Weddinger Wiesel. Die App läuft im Browser — kein Download, keine Installation. Einfach URL aufrufen und loslegen.

📚	Drill-Bibliothek
70+ Drills, filterbar, mit Beschreibung & Coaching-Punkten

📋	Trainingsplanung
Pläne aus Blöcken bauen, Drills zuweisen, exportieren

📅	Saisonplanung
Phasen mit Zeitraum, Ziel & Tracking

📊	Tracking
Drill-Einsatz über die Saison auswerten

🤖	KI Drill-Import
Drills per Freitext oder Foto automatisch importieren

👥	Multi-User
Eigenes Kürzel, geteilte und private Inhalte

Erste Schritte
App öffnen
Die App läuft im Browser — einfach folgende URL aufrufen:
davidinho2303.github.io/wiesel2-dashboard/Drill.html
...
Einloggen
Beim ersten Start erscheint ein Login-Screen. Gib dein Kürzel ein (z.B. "max", "anna") und tippe Speichern.
⦁	Nur Kleinbuchstaben und Zahlen — wird automatisch erzwungen
⦁	Kürzel merken — solange kein Google Login existiert ist es dein einziger Zugang
⦁	Falls das Kürzel schon vergeben ist, kommt eine Warnung mit der Option trotzdem fortzufahren

💡	Das Kürzel ist kein Passwort — wer es kennt kann sich damit einloggen. Für den Vereins-Betrieb ist das bewusst so gewählt, bis Google Login implementiert ist.
...
📚 Drill-Bibliothek
Alle Drills des Teams — über 70 Einträge, filterbar nach allen relevanten Dimensionen.
Filtern & Suchen
...
2.	Tab wählen: Text oder Bild
3.	"Analysieren" tippen — Claude erkennt alle Drills im Input
4.	Erkannte Drills prüfen und bei Bedarf anpassen
5.	"Ausgewählte speichern" → fertig, Drills sind sofort in der Bibliothek
Text-Modus
...
assistr · Weddinger Wiesel · Saison 2025/2026
